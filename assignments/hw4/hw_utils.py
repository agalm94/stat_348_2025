...
def get_scorpion_search_grid(image_path='img/underwater.png'):
    CELL_SIZE = 20
    ORIGIN_CELL = (16, 12)
...
def plot_scorpion_search_grid(image_path='img/underwater.png', show=False):
...
def plot_scorpion_path(seq, img=None, grid=None, image_path='img/underwater.png', show=False):
...
def plot_dist_on_scorpion_search_grid(dist, max_alpha=255, vmin=0.01, show=False, image_path='img/underwater.png'):
    grid, img = get_scorpion_search_grid(image_path)
